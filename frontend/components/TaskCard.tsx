...
const TaskCard: React.FC<TaskCardProps> = ({ task, onToggleComplete, onDelete, isLoading = false }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-center text-xs text-gray-500">
                ...
                {task.deadline && (
                    <span className={isOverdue ? "text-red-500 font-medium" : ""}>Prazo: {formatDate(task.deadline)}</span>
                )}
            </div>
